<template>
  <div class="kmain-container">
    ...
    <div class="pitch-visualization">
      ...
      <div id="echarts-container" style="height: 300px; width: 500px"></div>
    </div>
...
import { lyric_music } from '../stores/lyric.js'
const getLyricMusic = lyric_music()
...
//图表
const totalData = ref(JSON.parse(/* localStorage.getItem('responseData' )*/getLyricMusic.highData));
...
onMounted(() => {
  ...
  myurl.value = basePath + /* localStorage.getItem("Name") */getLyricMusic.lrc_filename;
  //游标部分
...
const currentTrack = ref({
  src:
    "/src/assets/output/" + /* localStorage.getItem("Name") */ getLyricMusic.lrc_filename+ "/accompaniment.wav",
});
const vocalcurrentTrack = ref({
  src: "/src/assets/output/" + /* localStorage.getItem("Name")  */getLyricMusic.lrc_filename+ "/vocals.wav",
});
//const volume = ref(70);
...
const mylrcText = ref(getLyricMusic.lrcContext/* localStorage.getItem("lrcData") */);
const parseLRC = (lrcText) => {
  console.log(mylrcText.value)
