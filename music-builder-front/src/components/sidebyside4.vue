      ...
      <el-form :model="form" @submit.prevent="handleSubmit">
        <el-form-item label="乐器:" :label-width="formLabelWidth">
          <el-select v-model="form.instrument" placeholder="Please select a zone"> 
            <el-option label="大钢琴" value="Acoustic Grand" />
            <el-option label="大扬琴" value="Dulcimer" />
            <el-option label="手风琴" value="Accordion" />
            <el-option label="钢弦吉他" value="Acoustic Guitar(steel)" />
            <el-option label="大贝司" value="Acoustic Bass" />
            <el-option label="小提琴" value="Violin" />
            <el-option label="弦乐合奏" value="String Ensemble 1" />
            <el-option label="长号" value="Trombone" />
            <el-option label="中音萨克斯" value="Tenor Sax" />
            <el-option label="竖笛" value="Recorder" />
            <el-option label="合成主音6(人声)" value="Lead 6 (voice)" />
            <el-option label="合成音色2(温暖)" value="Pad 2 (warm)" />
            <el-option label="合成效果5(明亮)" value="FX 5 (brightness)" />
            <el-option label="太鼓" value="Taiko Drum" />
          </el-select>
        </el-form-item>
